...
#Filtrage de la population Totale de la ville saisie en 2008
for i in range(len(table2008)):
    if table2008[i][6] == Ville:
        Pop2008 =int(table2008[i][9])

#Filtrage de la population Totale de la ville saisie  en 2016
...
#Filtrage de la population Totale de la ville saisie  en 2021
for i in range(len(table2021)):
    if table2021[i][2] == CodeCom:
        Pop2021=int(table2021[i][5])

#Filtrage de la population Totale de la ville saisie  en 2023
...
title(f"Evolution de la Population de {Ville}") #Mise en place d'un titre
